...
```sh
python3 .opencode/skills/go-import-check/scripts/check.py
```

To check selected repositories:

```sh
python3 .opencode/skills/go-import-check/scripts/check.py repo/longhorn-instance-manager repo/longhorn-manager
```
